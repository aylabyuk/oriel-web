    ...
    <>
      ...
      <animated.div
        className={cn(
          ...
          'rounded-2xl bg-neutral-900/95 shadow-2xl backdrop-blur-md',
          'sm:inset-8',
        )}
        style={{
          opacity: springs.opacity,
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-white/10 px-5 py-4">
          ...
          <button
            ...
            className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-white/60 transition-colors hover:bg-white/10 hover:text-white focus:ring-2 focus:ring-white/50 focus:outline-none"
          >
          ...
          <section>
            ...
            <ul className="mt-2 space-y-1 text-xs text-white/60">
              <li className="flex items-center gap-2">
                <span className="inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-white/40" />
        ...
        <div className="shrink-0 border-t border-white/10 px-5 py-3">
          <button
            onClick={onClose}
            className="w-full cursor-pointer rounded-lg border border-white/20 py-2 text-xs font-medium text-white/70 transition-colors hover:bg-white/10 hover:text-white focus:ring-2 focus:ring-white/50 focus:outline-none"
          >
            {t('rules.close')}
          </button>
        </div>
